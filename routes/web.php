...
Route::get('signup', 'UsersController@create')->name('signup');//  /signup 跟 signup一样
...
Route::delete('/users/followers/{user}', 'FollowersController@destroy')->name('followers.destroy'); //取消用户